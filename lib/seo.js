...
const OG_LOCALE = {
  en: "en_US", zh: "zh_CN", "zh-TW": "zh_TW", ja: "ja_JP", vi: "vi_VN", th: "th_TH",
  id: "id_ID", es: "es_ES", hi: "hi_IN", ar: "ar_AR", pt: "pt_BR", ru: "ru_RU",
  fr: "fr_FR", de: "de_DE", it: "it_IT", tr: "tr_TR", fil: "tl_PH", ms: "ms_MY", bn: "bn_BD",
  ko: "ko_KR",
};
 ...
 *  `image` must be a real file under public/ — verify-seo.mjs checks that it exists. */
