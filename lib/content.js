...
import stayRu from "../data/stay.ru.json";
import stayFr from "../data/stay.fr.json";
...
import itinRu from "../data/itineraries.ru.json";
import itinFr from "../data/itineraries.fr.json";
