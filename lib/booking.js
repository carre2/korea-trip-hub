...
// Address-based hotel map — no per-city IDs needed. Set STAY22.aid to your
// Stay22 affiliate id to switch the maps on; while empty, <Stay22Map> renders
// nothing (no third-party embed loads), so it's inert until you're approved.
