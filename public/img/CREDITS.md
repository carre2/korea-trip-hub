...
| File | Source | Author | License | Page |
|------|--------|--------|---------|------|
| visa/incheon-arrivals.jpg | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Incheon_International_Airport_departures.jpg) | Pmsyyz | CC BY-SA 4.0 | Plan → Visa & K-ETA |
| transit/seoul-subway.jpg | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Seoul-metro-125-Jegidong-station-platform-20181122-121456.jpg) | LERK | CC BY-SA 4.0 | Plan → Getting Around |
...
## Rules
- Prefer: KTO Photo Korea (한국관광공사), Wikimedia Commons (CC), Unsplash License.
- Always record author + license + source URL here and show credit inline.
- CC BY / CC BY-SA require visible attribution (author + license). Unsplash does not, but we credit anyway.
- **공유 카드(og:image)에는 CC BY/BY-SA 사진을 쓰지 않는다.** 크레딧을 노출할 자리가 없기 때문 —
  자체 제작 이미지만 사용한다 (`og/ktriphub-og.jpg`).
- Never hotlink; download into /public/img and serve locally.
...
| bukchon | Photo: Basile Morin / Wikimedia Commons · CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Bukchon-ro_11-gil_street_with_hanok_houses_at_blue_hour_in_Bukchon_Hanok_Village_Seoul.jpg) |
| hongdae | Photo: lumoplank / Wikimedia Commons · CC0 | [Commons](https://commons.wikimedia.org/wiki/File:Hongdae%2C_Seoul-_Part_II_-_Hongdae2237.jpg) |
| seongsu | Photo: CartoonChess / Wikimedia Commons · CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Snowy_shopping_street_in_Seongsu-dong.jpg) |
| bukhansan | Photo: Jo Hanshin / Wikimedia Commons · CC0 | [Commons](https://commons.wikimedia.org/wiki/File:Bukhansan_Spring_in_Korea.jpg) |
| dmz | Photo: Nicor / Wikimedia Commons · CC BY-SA 3.0 | [Commons](https://commons.wikimedia.org/wiki/File:Demilitarized_Zone_of_Korea_16.JPG) |
| haeundae | Photo: StephNurnberg / Wikimedia Commons · CC BY 2.0 | [Commons](https://commons.wikimedia.org/wiki/File:Haeundae_Beach_in_Busan.jpg) |
| gamcheon | Photo: Basile Morin / Wikimedia Commons · CC BY-SA 4.0 | [Commons](https://commons.wikimedia.org/wiki/File:Colorful_houses_in_Gamcheon_Culture_Village_at_sunset_in_Busan_South_Korea.jpg) |
