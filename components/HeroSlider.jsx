...
export default function HeroSlider({ locale, t, languageCount, image, imageLabel }) {
  return <section className="journey-hero"><div className="wrap journey-hero-grid">
    <div className="journey-intro"><span className="korea-wordmark" lang="ko" aria-hidden="true">한국</span><span className="journey-kicker">KOREA TRIP HUB <span>— {t.languages.replace('{n}', languageCount)}</span></span>
